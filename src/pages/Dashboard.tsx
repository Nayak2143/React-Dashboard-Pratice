  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="card rounded-md p-5 bg-background relative overflow-hidden">
        ...
        {/* rotated background */}
        <div className="bg-blue-100/70 rounded-bl-2xl absolute top-10 -right-12 w-24 h-24 rotate-50">
          {/* center icon */}
      ...
      <div className="card rounded-md p-5 bg-background relative overflow-hidden">
        ...
        <h1 className="text-4xl mt-2">00</h1>
        <div className="bg-red-100/70 rounded absolute top-0 -right-12 w-24 h-24 rotate-50">
          <div className="absolute inset-0 flex items-center justify-center -rotate-50 -left-7 -bottom-7">
      ...
      <div className="card rounded-md p-5 bg-background relative overflow-hidden">
        ...
        <h1 className="text-4xl mt-2">00</h1>
        <div className="bg-yellow-100/70 rounded absolute top-0 -right-12 w-24 h-24 rotate-50">
          <div className="absolute inset-0 flex items-center justify-center -rotate-50 -left-7 -bottom-7">
      ...
      <div className="card rounded-md p-5 bg-background relative overflow-hidden">
        ...
        <h1 className="text-4xl mt-2">00</h1>
        <div className="bg-green-100/70 rounded absolute top-0 -right-12 w-24 h-24 rotate-50">
          <div className="absolute inset-0 flex items-center justify-center -rotate-50 -left-7 -bottom-7">
